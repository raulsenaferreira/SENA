...
def main():
    ...
    for transform in additional_transforms:
        ...
        print("Dist shift experiments with {} as ID and {} as OOD transformation".format(id_dataset, transform))
        ...
        dataset_ood = Dataset(ood_dataset, "train", model, additional_transform=transform, batch_size=batch_size)
        ...
        utils.save_baseline_results(ood_type, transform, id_dataset, ood_dataset,
